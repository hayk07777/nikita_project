      ...
      <div className="contact__container">
        ...
        <article className="footer__wrapper">
          <div className="title__part">
            <h1>Կապ մեզ հետ</h1>
            <p>
              Մենք տրամադրում ենք շուրջօրյա ծառայություն, <br /> 
          ...
          <form className="footer__form">
            <div className="inputs__row">
              <div className="input__item">
                <p>Անուն*</p>
                <input type="text" placeholder="Անուն" className="standard__in" />
              </div>
              <div className="input__item">
                <p>Ազգանուն*</p>
                <input type="text" placeholder="Ազգանուն" className="standard__in" />
              </div>
            </div>

            <div className="input__item">
              <p>Էլ. փոստ*</p>
              <input type="email" placeholder="Էլ. փոստ" className="standard__in" />
            </div>
            ...
            <div className="inputs__row">
              <div className="input__item">
                ...
                <div className="phone__select">
                  ...
                  <input type="tel" placeholder="552123456" />
                </div>
              </div>
            </div>
            ...
            <div className="input__item">
              <p>Բովանդակություն*</p>
              <textarea placeholder="Բովանդակություն" className="textarea__in"></textarea>
            </div>
            ...
            <button type="submit" className="submit__btn">Ուղարկել</button>
          </form>
        </article>
